...
**<span style="font-size:1.5em;">This repository is also called T-REx and contains three scripts for analyzing tandem sequences using genome (the first two scripts) and short reads (monoMiner)🦖🧬:</span>**
