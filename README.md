...
<table>
  <tr>
    <td>
      <strong>This repository is also called T-REx and contains three scripts for analyzing tandem sequences using genome (the first two scripts) and short reads (monoMiner) 🦖🧬:
.</strong><br>
